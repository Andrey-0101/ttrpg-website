...
Add only the route/UI, server operations, and tests required to manage the existing campaign image model and private Storage contract. Do not create a general `handouts` domain.
